...
class LabelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create label" do
    assert_difference("Label.count") do
      post labels_url, params: { label: { board_id: @label.board_id, id: @label.id, name: @label.name } }
    end
  ...
  test "should update label" do
    patch label_url(@label), params: { label: { board_id: @label.board_id, id: @label.id, name: @label.name } }
